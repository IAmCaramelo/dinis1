...
app.set('trust proxy',config.ip);                       // Forçar a utilização de ssl


app.set('view engine','pug');                           // A usar pug anteriormente conhecido 
                                                        // como jade em vez de html
...
app.listen(config.port,config.ip);                      // Começa a escutar ligaçoes na porta e ip
                                                        // especificado no ficheiro config
